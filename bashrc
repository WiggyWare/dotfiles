...
# Petar Marinov, http:/geocities.com/h2428, this is public domain
 cd_func ()
 {
   ...
   popd -n +5 2>/dev/null 1>/dev/null
 
   #
   # Remove any other occurence of this dir, skipping the top of the stack
   for ((cnt=1; cnt <= 5; cnt++)); do
...
# Other aliases
# set up the proxy for curl
#alias curl='curl -x http.proxy.fmr.com:8000'
...
[[ -s "/home/a249261/.gvm/bin/gvm-init.sh" ]] && source "/home/a249261/.gvm/bin/gvm-init.sh"
alias hdyu='~/scripts/howdoyouunix/how-do-you-unix.sh'
